...
public final class P2pLibManager {
    ...
    public boolean GetVpnNode() {
        ...
        seckey = info_split[3];
        public_key = getPublicKey();
        System.out.println("vpn node: " + choosed_vpn_ip + ":" + choosed_vpn_port + ":" + seckey + ":" + public_key);
        return true;
    }
